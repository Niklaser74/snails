...
1. Deterministisk simulering och indata-händelser (grunden för allt).
2. Testerna in i repot och CI.
3. Två nya vapen och lådor.
4. Tutorial och engelsk översättning av all text.
5. Mätning på plats.
